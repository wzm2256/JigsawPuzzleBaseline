...
img_path = 'dataset/540/2.jpg'; % image path
...
[res_all_sol, err_all, real_goal_all, res_all, rotsNum_first, rotsNum, large_Image] = solve_type_2_img(img_path, patch_size, cols, rows, number_iter);
