    ...
    def __init__(
        ...
        self.transforms = transforms.Compose(
            [
                ...
                # I removed this augmentation, because this augmentation is not used in the original code. In addition,
                # flipping the pieces does not make too much sense, because there is no correct transformation for the
                # flipped piece.
                transforms.ToTensor(),
            ]
        )
