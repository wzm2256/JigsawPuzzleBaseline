...
# import wandb
# import model
# torch.serialization.add_safe_globals([model.spatial_diffusion.ModelMeanType])
...
def main(
    ...
    if rotation:
        ...
        raise NotImplementedError('Only deal with rotated pieces.')
    ...
    if evaluate:
        ...
        checkpoint_path = sorted(glob.glob(f"lightning_logs/{version_id}/checkpoints/*"))[-1]
        print('---------------')
        print(checkpoint_path)
        print('---------------')
...
if __name__ == "__main__":
    ...
    ap.add_argument("--degree", type=Percent, default="80%")

    ap.add_argument("--virt_nodes", type=int, default=8)
    ...
    ap.add_argument("--rotation", type=bool, default=True)
    ...
    ap.add_argument("--backbone", type=str, default="resnet18equiv")
    ap.add_argument("--architecture", type=str, default="exophormer")
    ...
    ap.add_argument("--version_id", type=str, default="exophormer")
